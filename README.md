...
<h2>Обо мне</h2>
<b>Меня зовут Кирилл, я front-end разработчик, в данном профиле вы можете увидеть текущие проекты, над которыми я работаю, а также завершенные проекты.</b>
</br>
</br>
<b>Приятного ознакомления!</b>
</br>
